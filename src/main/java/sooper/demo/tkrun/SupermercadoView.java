...
public void rellenaListaArticulos(Object[] rowArticulo) {
	...
	public JTable getTable () {
		...
		return this.table; // envia la tabla al controlador , definimos un getter
	}
...
/*	public void rellenaTablaEmbolsados(Object[] rowArticulo) {
		this.modeloListaEmbolsados.addRow(rowArticulo);
	}
*/
}
